...
export default function Settings({ settings, onSave, activeInstance, onNavigate }: Props): React.ReactElement {
  ...
  return (
    <div style={{ maxWidth: 680 }}>
        ...
        <div style={{ fontSize:'0.85rem', color:'var(--text2)', lineHeight:1.7 }}>
          ...
          <div style={{ marginTop:8, display:'flex', flexDirection:'column', gap:6 }}>
            <div>
              ...
              <button
                onClick={() => elApi()?.openExternal('mailto:support@servicenow-mcp.com')}
                style={{ background:'none', border:'none', color:'var(--accent)', cursor:'pointer', padding:0, fontSize:'0.85rem' }}
              >support@servicenow-mcp.com</button>
            </div>
            <div>
              <span style={{ color:'var(--dim)', fontSize:'0.78rem', marginRight:8 }}>Issues</span>
              <button
                onClick={() => elApi()?.openExternal('https://github.com/cvetomirgrigorov/servicenow-mcp/issues')}
                style={{ background:'none', border:'none', color:'var(--accent)', cursor:'pointer', padding:0, fontSize:'0.85rem' }}
      ...
      {section('About', <>
        <div style={{ fontSize:'0.85rem', color:'var(--text2)', lineHeight:1.7 }}>
          <div><strong>servicenow-mcp</strong> — Your AI companion for ServiceNow</div>
          <div>Config: <code style={{ fontSize:'0.8rem' }}>~/.config/servicenow-mcp/</code></div>
          ...
          <div style={{ marginTop:12, fontSize:'0.72rem', color:'var(--dim)', lineHeight:1.6 }}>
            ...
            <button
              onClick={() => elApi()?.openExternal('https://github.com/cvetomirgrigorov/servicenow-mcp/blob/main/LICENSE')}
            ...
            <button
              onClick={() => elApi()?.openExternal('https://github.com/cvetomirgrigorov/servicenow-mcp/blob/main/TERMS.md')}
              style={{ background:'none', border:'none', color:'var(--dim)', cursor:'pointer', padding:0, fontSize:'0.72rem', textDecoration:'underline' }}
