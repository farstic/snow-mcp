/**
 * First-run setup wizard (GUI version of `servicenow-mcp setup`).
      ...
      <div style={styles.card}>
        ...
        {step === 'test' && (
          <>
            ...
            <p style={styles.sub}>Verify servicenow-mcp can reach your ServiceNow instance.</p>
        ...
        {step === 'clients' && (
          <>
            ...
            <p style={styles.sub}>servicenow-mcp will write the config automatically. You can also do this later from the Instances page.</p>
        ...
        {step === 'done' && (
          <>
            ...
            <p style={styles.sub}>
              servicenow-mcp is connected to <strong>{form.instanceUrl}</strong> as <strong>{form.instanceName}</strong>.
            </p>
