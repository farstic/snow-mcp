...
- Changeset management
- Core read tools
- Requires: `WRITE_ENABLED=true`, `SCRIPTING_ENABLED=true` (for snow_intg_event_register)
...
| `integration_engineer` | true | `SCRIPTING_ENABLED=true` (for snow_intg_event_register) |
